...
namespace ProgrammersBlog.Services.Concrete
{
    public class ArticleManager : IArticleService
    {
        ...
        public ArticleManager(UnitOfWork unitOfWork, IMapper mapper = null)
        {
        ...
        public async Task<IResult> Delete(int articleId, string modifiedByName)
        {
            ...
            return new Result(ResultStatus.Error, "böyle bir   makale başarıyla eklenmiştir");
        ...
        public async Task<IDataResult<ArticleListDto>> GetAllByCategory(int categoryId)
        {
            ...
            if (result)
            {
                var article = await _unitOfWork.Articles.GetAllAsync(a => a.CategoryId == categoryId && !a.IsDeleted && a.IsActive,
        ...
        {
            var article=await _unitOfWork.Articles.GetAllAsync(a=>!a.IsDeleted, a=>a.User,ar=>ar.Category);
            if (article.Count > -1)
            {
                return new DataResult<ArticleListDto>(ResultStatus.Success, new ArticleListDto
                {
        ...
        public async Task<IDataResult<ArticleListDto>> GetAllNonDeletedEndActive()
        {
            var article = await _unitOfWork.Articles.GetAllAsync(a=>!a.IsDeleted && a.IsActive, a=>a.User , a=>a.Category);
            if (article.Count > -1)
            {
                return new DataResult<ArticleListDto>(ResultStatus.Success, new ArticleListDto
                {
        ...
        public async Task<IResult> Update(ArticleUpdateDto articleUpdateDto, string modifiedByName)
        {
            ...
            return new Result(ResultStatus.Success, $"{articleUpdateDto.Title} başlıklı makale başarıyla güncellnmiştir");
